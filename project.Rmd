...
wildboar_scared_schreck <- wildboar_scared_schreck %>% 
  select(ausrichtung_dir, directionRelative, dist, lautstaerke, scareEffect, modus) %>% 
...
plot(wildboar_scared_schreck2$scareEffect, wildboar_scared_schreck2$soundDistance)
